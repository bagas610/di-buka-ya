...
// Dirubah 
const pengirim = "hallo kakak pemandu, Nama Kamu Siapa ?";
const nomorWa = "6283144555023" 
const textWa = "apakah kamu mau mala? yes or no"
const pesan = `semogga kamu suka apa yang aku buat, dan terimakasih udah buka ini. yakult atau nurmala soalnya biasanya marah kallo di panggil yakult. apakah kamu mau jadi pacarku?`;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    imageHeight: 120,
    title: 'hallo kakak pemandu, Nama Kamu Siapa ?',
    ...
    let txt = `Halo ${result.value.login}, kamu cantik, pasti nama kamu berawal dari huruf ${namaAwal.toUpperCase()}, ${pesan}`;
